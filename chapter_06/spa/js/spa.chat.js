...
spa.chat = (function () {
    ...
    var configMap = {
        ...
        jqueryMap = {},
        getEmSize, setPxSizes, scrollChat,
    ...
    //移除 getEmSize 方法，因为现在浏览器端工具方法集 spa.util_b.js里面已经有这个方法了。
    ...
    onSetchatee = function ( event, arg_map ) {
        ...
        jqueryMap.$list_box.find('.spa-chat-list-name').removeClass('spa-x-select').end()
